...
This project will evolve throughout the semester, starting from a basic interactive demo for **Checkpoint 1** and expanding into a fully featured game with menus, settings, animations, and scoring.
...
The goal is to develop a complete interactive game that includes:
- A visual **LCD-based menu system**
- **Joystick-controlled gameplay**
- **LED matrix animations**
- Progressive difficulty
- Highscore system
- Settings and sound control (to be added in later checkpoints)
